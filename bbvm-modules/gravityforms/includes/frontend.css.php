...
$background_color = BBVapor_Modules::get_color( $background_color );
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> span label {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->form_sub_label_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_label {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->form_label_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
if ( ! empty( $settings->progress_title_color ) ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper h3.gf_progressbar_title {
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_title_color ) ); ?>;
	}
	<?php
endif;
...
if ( ! empty( $settings->progress_bar_inner_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar_percentage {
		background-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_bar_inner_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_bar_outer_color ) ) :
	...
	$progress_bar_outer_background_color = BBVapor_Modules::get_color( $progress_bar_outer_background_color );
	?>
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar {
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_progressbar_wrapper .gf_progressbar_percentage span {
	display: inline-block;
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_bar_text_color ) ); ?>;
}
<?php
...
if ( ! empty( $settings->progress_steps_active_background_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		background-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_active_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_active_text_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_steps_active_border_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_active, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed,   {
		border-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_active_border_color ) ); ?>;
		border-style: solid;
	}
	<?php
endif;
...
if ( ! empty( $settings->progress_steps_inactive_background_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		background-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_inactive_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_inactive_text_color ) ); ?>;
	}
	<?php
endif;
if ( ! empty( $settings->progress_steps_inactive_border_color ) ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_pending,
	.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gf_page_steps .gf_step.gf_step_completed {
		border-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->progress_steps_inactive_border_color ) ); ?>;
		border-style: solid;
	}
	<?php
endif;
...
$input_background_color = BBVapor_Modules::get_color( $input_background_color );
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url] {
	...
	border: <?php echo absint( $settings->input_border_width ); ?>px solid <?php echo esc_html( BBVapor_Modules::get_color( $settings->input_border_color ) ); ?>;
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->input_text_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=text],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=password],
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=email],
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> input[type=url]::placeholder,
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea::placeholder {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->placeholder_color ) ); ?>;
}
<?php
FLBuilderCSS::typography_field_rule(
	array(
...
$textarea_background_color = BBVapor_Modules::get_color( $textarea_background_color );
?>
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> textarea {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->textarea_color ) ); ?>;
	background: <?php echo esc_html( $textarea_background_color ); ?>;
	border-color: #<?php echo esc_html( BBVapor_Modules::get_color( $settings->textarea_border_color ) ); ?>;
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->list_color ) ); ?>;
}
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_checkbox label:before {
	...
	margin-right: 10px;
	background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->list_background ) ); ?>;
	border-width: <?php echo absint( $settings->list_border ); ?>px;
	border-style: solid;
	border-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->list_border_color ) ); ?>;
	padding: 4px;
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_radio input[type="radio"]:checked + label::before {
	...
	background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->list_selected_color ) ); ?>;
}
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gform_title, .fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-gravityforms-for-beaverbuilder .form-heading {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->form_title_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gform_description, .fl-node-<?php echo esc_html( $id ); ?> .fl-bbvm-gravityforms-for-beaverbuilder .form-description {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->form_description_color ) ); ?>;
}
...
$button_background_color = BBVapor_Modules::get_color( $button_background_color );
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> button {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->button_color ) ); ?>;
	background: <?php echo esc_html( $button_background_color ); ?>;
	border-width: <?php echo absint( $settings->button_border ); ?>px;
	border-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->button_border_color ) ); ?>;
}
<?php
$button_background_hover_color = isset( $settings->button_background_hover ) ? esc_attr( $settings->button_background_hover ) : '000000';
$button_background_hover_color = BBVapor_Modules::get_color( $button_background_hover_color );
?>
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> button:hover {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->button_color_hover ) ); ?>;
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .validation_error {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->error_message_color ) ); ?>;
	border-top-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->error_message_color ) ); ?>;
	border-bottom-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->error_message_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> li.gfield.gfield_error {
	background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->error_label_background_color ) ); ?>;
}
.fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_error .gfield_label, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> li.gfield_error div.ginput_complex.ginput_container label, .fl-node-<?php echo esc_html( $id ); ?> #gform_<?php echo esc_html( $settings->form ); ?> .gfield_description.validation_message {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->error_label_color ) ); ?>;
}
<?php
...
.fl-node-<?php echo esc_html( $id ); ?> #gform_confirmation_wrapper_<?php echo esc_html( $settings->form ); ?> {
	color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->confirmation_color ) ); ?>;
	background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->confirmation_background_color ) ); ?>;
}
