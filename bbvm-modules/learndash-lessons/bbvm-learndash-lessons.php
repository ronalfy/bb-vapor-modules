...
class BBVapor_LearnDash_Lessons extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name'            => __( 'LearnDash Lessons', 'bb-vapor-modules' ),
				'description'     => __( 'LearnDash Lessons', 'bb-vapor-modules' ),
				'category'        => __( 'LearnDash', 'bb-vapor-modules' ),
				'group'           => apply_filters( 'bbvm_whitelabel_category', __( 'Vapor', 'bb-vapor-modules' ) ),
				'dir'             => BBVAPOR_BEAVER_BUILDER_DIR . 'bbvm-modules/learndash-lessons/',
				'url'             => BBVAPOR_BEAVER_BUILDER_URL . 'bbvm-modules/learndash-lessons/',
			...
			'sections' => array(
				'container' => array(
					...
					'fields' => array(
						'user_lessons'              => array(
							'type'    => 'select',
							'label'   => __( 'Show User Lessons Only', 'bb-vapor-modules' ),
							'default' => 'false',
							'options' => array(
						...
						'category_selector'         => array(
							'type'    => 'select',
							'label'   => __( 'Display a Category Dropdown', 'bb-vapor-modules' ),
							'default' => 'true',
							'options' => array(
								'false' => __( 'No', 'bb-vapor-modules' ),
								'true'  => __( 'Yes', 'bb-vapor-modules' ),
						...
						'category_selector_padding' => array(
							'type'       => 'dimension',
							'label'      => __( 'Category Selector Paddig', 'bb-vapor-modules' ),
							'responsive' => true,
						),
					),
				),
				...
				'styles' => array(
					...
					'fields' => array(
						'lesson_background_color'       => array(
							'type'       => 'color',
							'label'      => __( 'Lesson Background Color', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'lesson_background_color_hover' => array(
							'type'       => 'color',
							'label'      => __( 'Lesson Background Color on Hover', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'lesson_anchor_color'           => array(
							'type'       => 'color',
							'label'      => __( 'Lesson Link Color', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'lesson_anchor_color_hover'     => array(
							'type'       => 'color',
							'label'      => __( 'Lesson Link Color on Hover', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'border'                        => array(
							'type'  => 'border',
							'label' => __( 'Lesson Item Border', 'bb-vapor-modules' ),
						),
					),
				),
			),
				...
				'colors' => array(
					...
					'fields' => array(
						...
						'lesson_price_heading'   => array(
							'type'       => 'color',
							'label'      => __( 'Lesson Heading Color', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'percentage_text_color'  => array(
				...
				'typography' => array(
					...
					'fields' => array(
						'lesson_typography'     => array(
							'type'       => 'typography',
							'label'      => __( 'Lesson Typography', 'bb-vapor-modules' ),
							'responsive' => true,
						),
						'price_typography'      => array(
							'type'       => 'typography',
							'label'      => __( 'Lesson Heading Typography', 'bb-vapor-modules' ),
							'responsive' => true,
						),
