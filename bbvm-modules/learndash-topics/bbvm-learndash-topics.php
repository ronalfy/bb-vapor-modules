...
class BBVapor_LearnDash_Topics extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name'            => __( 'LearnDash Topics', 'bb-vapor-modules' ),
				'description'     => __( 'LearnDash Topics', 'bb-vapor-modules' ),
				'category'        => __( 'LearnDash', 'bb-vapor-modules' ),
				'group'           => apply_filters( 'bbvm_whitelabel_category', __( 'Vapor', 'bb-vapor-modules' ) ),
				'dir'             => BBVAPOR_BEAVER_BUILDER_DIR . 'bbvm-modules/learndash-topics/',
				'url'             => BBVAPOR_BEAVER_BUILDER_URL . 'bbvm-modules/learndash-topics/',
