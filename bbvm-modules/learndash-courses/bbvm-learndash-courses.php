...
class BBVapor_LearnDash_Courses extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(
			array(
				'name'            => __( 'LearnDash Courses', 'bb-vapor-modules' ),
				'description'     => __( 'LearnDash Courses', 'bb-vapor-modules' ),
				'category'        => __( 'LearnDash', 'bb-vapor-modules' ),
				'group'           => apply_filters( 'bbvm_whitelabel_category', __( 'Vapor', 'bb-vapor-modules' ) ),
				'dir'             => BBVAPOR_BEAVER_BUILDER_DIR . 'bbvm-modules/learndash-courses/',
				'url'             => BBVAPOR_BEAVER_BUILDER_URL . 'bbvm-modules/learndash-courses/',
			...
			'sections' => array(
				'container' => array(
					...
					'fields' => array(
						'user_courses'              => array(
							'type'    => 'select',
							'label'   => __( 'Show User Courses Only', 'bb-vapor-modules' ),
							'default' => 'false',
							'options' => array(
				...
				'styles' => array(
					...
					'fields' => array(
						'course_background_color'       => array(
							'type'       => 'color',
							'label'      => __( 'Course Background Color', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'course_background_color_hover' => array(
							'type'       => 'color',
							'label'      => __( 'Course Background Color on Hover', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'course_anchor_color'           => array(
							'type'       => 'color',
							'label'      => __( 'Course Link Color', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'course_anchor_color_hover'     => array(
							'type'       => 'color',
							'label'      => __( 'Course Link Color on Hover', 'bb-vapor-modules' ),
							'show_alpha' => true,
							'show_reset' => true,
						),
						'border'                        => array(
							'type'  => 'border',
							'label' => __( 'Course Item Border', 'bb-vapor-modules' ),
						),
					),
				),
			),
