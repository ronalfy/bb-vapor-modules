...
<?php if ( 'yes' === $settings->display_caption && 'overlay' === $settings->caption_display ) : ?>
	.fl-node-<?php echo esc_html( $id ); ?> figcaption * {
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->overlay_text_color ) ); ?> !important;
	}
	...
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo figure.horizontal figcaption.top {
		background-color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->overlay_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->overlay_text_color ) ); ?>;
		position: absolute;
		width: 100%;
		top: 0;
		left: 0;
	...
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo figure.full figcaption {
		...
		justify-content: center;
		position: absolute;
		background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->overlay_background_color ) ); ?>;
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->overlay_text_color ) ); ?>;
		width: 100%;
		height: 100%;
		z-index: 20;
...
if ( 'none' !== $settings->image_border_type ) :
	?>
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo figure img {
		border: <?php echo absint( $settings->image_border_width ); ?>px <?php echo esc_html( $settings->image_border_type ); ?> <?php echo esc_html( BBVapor_Modules::get_color( $settings->image_border_color ) ); ?>; 
	}
	<?php
endif;
...
if ( 'below' === $settings->caption_display ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo figcaption,
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo figcaption * {
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->caption_text_color ) ); ?>;
		background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->caption_background_color ) ); ?>;
	}
	<?php
	FLBuilderCSS::dimension_field_rule(
		array(
...
if ( 'yes' === $settings->display_title ) :
	...
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo-title,
	.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo-title * {
		color: <?php echo esc_html( BBVapor_Modules::get_color( $settings->title_text_color ) ); ?>;
		background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->title_background_color ) ); ?>;
	}
	<?php
	FLBuilderCSS::dimension_field_rule(
		array(
...
.fl-node-<?php echo esc_html( $id ); ?> .bbvm-photo-wrapper {
	background: <?php echo esc_html( BBVapor_Modules::get_color( $settings->container_background_color ) ); ?>;
}
